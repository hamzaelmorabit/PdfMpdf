...
$header = '
<table idth="100%" height="2100%"  style="border-bottom: 1px solid #000000; vertical-align: bottom; font-family: serif; font-size: 9pt;" >
  ...
  <tr style="margin:1330%;">
    ...
    padding-left:380px;font-size:13px;"><span style="
  
    font-weight:bold">Patient Name:</span>&nbsp;&nbsp; Image Test</td>
  </tr>
  <tr style="float:right">
    <td style="padding-left:380px;font-size:13px">
...
$html1 = '<div><img src="'.$graphLink.'" ></div>';
$html = '
<html>

<h2 class="tit">WOUND ASSESSMENT REPORT</h2>
...
<td width="33%">'.$html1.'</td>
<td width="33%">'.$html1.'</td>

</tr></table>

    <h1 class="hero">!!!!Trying to get some shit done</h1>

<div>Nulla felis erat, imperdiet eu, ullamcorper non, nonummy quis, elit. Suspendisse potenti. Ut a eros at ligula vehicula pretium. Maecenas feugiat pede vel risus. Nulla et lectus. Fusce eleifend neque sit amet erat. Integer consectetuer nulla non orci. Morbi feugiat pulvinar dolor. Cras odio. Donec mattis, nisi id euismod auctor, neque metus pellentesque risus, at eleifend lacus sapien et risus. Phasellus metus. Phasellus feugiat, lectus ac aliquam molestie, leo lacus tincidunt turpis, vel aliquam quam odio et sapien. Mauris ante pede, auctor ac, suscipit quis, malesuada sed, nulla. Integer sit amet odio sit amet lectus luctus euismod. Donec et nulla. Sed quis orci. </div>
